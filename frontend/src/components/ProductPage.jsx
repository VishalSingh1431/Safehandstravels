  ...
  const getTripContent = (location) => {
    const contentMap = {
      'Meghalaya': {
        ...
        video: trip.video || '/video/homepage.mp4',
            ...
            <section className="bg-gradient-to-br from-indigo-50 to-white rounded-2xl shadow-lg p-8 md:p-10 border border-indigo-100 hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="space-y-4">
                {content.itinerary.map((day, index) => (
                  <div 
                    key={index} 
                    className="relative bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border-l-4 border-[#017233] pl-8 pr-6 py-6 group"
                  >
                    <div className="absolute -left-3 top-8 w-6 h-6 rounded-full bg-[#017233] border-4 border-white shadow-lg group-hover:scale-125 transition-transform"></div>
                    <div className="flex items-start gap-4">
                      <div className="flex-shrink-0">
                        <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[#017233] to-[#01994d] flex items-center justify-center text-white font-bold text-lg shadow-lg">
                          {index + 1}
                        </div>
                      </div>
                      <div className="flex-1">
                        ...
                        <p className="text-gray-700 leading-relaxed text-base md:text-lg">{day.activities}</p>
                      </div>
                    </div>
                  </div>
                ))}
